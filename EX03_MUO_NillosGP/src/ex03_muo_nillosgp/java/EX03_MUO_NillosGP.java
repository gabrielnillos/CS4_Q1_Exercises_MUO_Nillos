 ...
 */
public class EX03_MUO_NillosGP {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        Singer singer2 = new Singer("Bill Evans", 73, 11500, song2);
        Singer singer3 = new Singer("Chick Corea", 69, 10900, song3);
        
        System.out.println("Singer 1\nName: " + singer1.name + "\nNo. of Performances: " + singer1.noOfPerformances + "\nEarnings (USD): " + singer1.getEarnings() + "\nFavorite Song: " + singer1.getFavoriteSong().title + "\n");
        System.out.println("Singer 2\nName: " + singer2.name + "\nNo. of Performances: " + singer2.noOfPerformances + "\nEarnings (USD): " + singer2.getEarnings() + "\nFavorite Song: " + singer2.getFavoriteSong().title + "\n");
        System.out.println("Singer 3\nName: " + singer3.name + "\nNo. of Performances: " + singer3.noOfPerformances + "\nEarnings (USD): " + singer3.getEarnings() + "\nFavorite Song: " + singer3.getFavoriteSong().title + "\n");
        
        singer1.performForAudience(12);
        singer1.setFavoriteSong(song2);
               
        System.out.println(singer1.name + "'s fave song is changed to " + singer1.getFavoriteSong().title +"\n");
        //System.out.println("\nSinger 1\nName: " + singer1.name + "\nNo. of Performances: " + singer1.noOfPerformances + "\nEarnings (USD): " + singer1.getEarnings() + "\nFavorite Song: " + singer1.favoriteSong.title + "\n");
        
        
        singer1.performForAudience(372, singer2);
        singer3.performForAudience(250, singer1);
